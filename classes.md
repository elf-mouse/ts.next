...
__accessible on__ | __public__ | __private__ | __protected__
----------------- | ---------- | ----------- | -------------
...
- `abstract` __classes__ cannot be directly instantiated. Instead the user must create some `class` that inherit from the `abstract class`.
- `abstract` __members__ cannot be directly accessed and a child class must provide the functionality.
