...
![Promise](img/promise-states-and-fates.png)
...
The chain-ability of promises __is the heart of the benefit that promises provide__. Once you have a promise, from that point on, you use the `then` function to create a chain of promises.
